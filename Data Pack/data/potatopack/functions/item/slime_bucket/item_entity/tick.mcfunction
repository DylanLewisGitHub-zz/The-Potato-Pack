...
execute unless score @s potatopack.slime_chunk_check.result = @s potatopack.slime_chunk_check.result_stored run function potatopack:item/slime_bucket/item_entity/update
